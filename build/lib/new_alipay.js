...
var NewAlipay = (function () {
     ...
     */
    NewAlipay.prototype.getWapParams = function () {
        var params = this.ali.wapPay({
            subject: '测试商品',
            body: '测试商品描述',
     ...
     * @param {String} [opts.return_url]         客户端回调地址，HTTP/HTTPS开头字符串
     */
    NewAlipay.prototype.getPcParams = function () {
     ...
     * returns {boolean}
     */
    NewAlipay.prototype.signVerify = function (response) {
